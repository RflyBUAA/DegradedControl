...
% Model Param
ModelParam_motorMinThr = 0.11;% 油门死区范围：0-1
ModelParam_motorFitType = 2;% 1表示使用线性拟合，2表示二次曲线拟合
ModelParam_motorCr = 0.0;
ModelParam_motorWb = 0;
ModelParam_motorRateCurveCoeffi = [-1057 2662 -94.98];%[p1 p2 p3]: f(x) = p1*x^2 + p2*x + p3

ModelParam_motorTc = 0.035;
ModelParam_rotorCt = 7.586e-06;
...
ModelParam_Airframe_m = 1.130;
ModelParam_Airframe_J = [0.012 0 0;0 0.012 0;0 0 0.02];                                                
% Fail Param
