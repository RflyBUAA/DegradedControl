...
% Model Param
ModelParam_motorMinThr = 0.05;% 油门死区范围：0-1
ModelParam_motorFitType = 1;% 1表示使用线性拟合，2表示二次曲线拟合
ModelParam_motorCr = 842.1;
ModelParam_motorWb = 0;
ModelParam_motorRateCurveCoeffi = [0 0 0];%[p1 p2 p3]: f(x) = p1*x^2 + p2*x + p3

ModelParam_motorTc = 0.0214;
ModelParam_rotorCt = 1.681e-05;
ModelParam_motorJm = 0.0000687;
% Fail Param
...
ModelParam_envC_md = [0.001 0.001 0.00058];%[0.0035 0.0039 0.0034];
    % Wind Param
...
ModelParam_Airframe_m = 1.31;
ModelParam_Airframe_J = [0.0194 0 0;0 0.0194 0;0 0 0.0291];                                                
% Fail Param
