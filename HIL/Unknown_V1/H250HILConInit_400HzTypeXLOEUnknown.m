...
clc
% Param on QGC
MY_TAU_P_P = Pixhawk_CSC.Parameter( {single(2.0), 'MY_TAU_P_P'}  );
MY_TAU_P_A = Pixhawk_CSC.Parameter( {single(0.2), 'MY_TAU_P_A'}  );
MY_TAU_P_P_YAW = Pixhawk_CSC.Parameter( {single(0.04), 'MY_TAU_P_P_YAW'}  );
MY_TAU_P_A_YAW = Pixhawk_CSC.Parameter( {single(0), 'MY_TAU_P_A_YAW'}  );

MY_RATE_P = Pixhawk_CSC.Parameter( {single(12), 'MY_RATE_P'}  );
MY_RATE_P_YAW = Pixhawk_CSC.Parameter( {single(0.0), 'MY_RATE_P_YAW'}  );

MY_ATT_P = Pixhawk_CSC.Parameter( {single(8), 'MY_ATT_P'}  );
MY_ATT_P_YAW = Pixhawk_CSC.Parameter( {single(0.0), 'MY_ATT_P_YAW'}  );

MY_POS_P = Pixhawk_CSC.Parameter( {single(0.6), 'MY_POS_P'}  );
