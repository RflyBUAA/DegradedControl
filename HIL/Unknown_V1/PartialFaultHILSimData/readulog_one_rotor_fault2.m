...
ulogOBJ = ulogreader("log_9_2021-6-30-08-04-24.ulg");
...
areamax = 20;
hold on
area([0,14],[areamax,areamax],areamin,'FaceColor','#c0e2c0','EdgeColor','#c0e2c0','FaceAlpha',.3,'EdgeAlpha',.0, ...
    'ShowBaseLine',"off",'LineWidth',5)
hold on
area([14,34],[areamax,areamax],areamin,'FaceColor','#ffd8b7','EdgeColor','#ffd8b7','FaceAlpha',.3,'EdgeAlpha',.0, ...
    'ShowBaseLine',"off",'LineWidth',5)
hold on
area([34,54],[areamax,areamax],areamin,'FaceColor','#A2142F','EdgeColor','#A2142F','FaceAlpha',.15,'EdgeAlpha',.0, ...
    'ShowBaseLine',"off",'LineWidth',5)
hold on
area([54,74],[areamax,areamax],areamin,'FaceColor','#c0e2c0','EdgeColor','#c0e2c0','FaceAlpha',.3,'EdgeAlpha',.0, ...
    'ShowBaseLine',"off",'LineWidth',5)
hold on
area([74,94],[areamax,areamax],areamin,'FaceColor','#ffd8b7','EdgeColor','#ffd8b7','FaceAlpha',.3,'EdgeAlpha',.0, ...
    'ShowBaseLine',"off",'LineWidth',5)
hold on
area([94,120],[areamax,areamax],areamin,'FaceColor','#A2142F','EdgeColor','#A2142F','FaceAlpha',.15,'EdgeAlpha',.0, ...
    'ShowBaseLine',"off",'LineWidth',5)
