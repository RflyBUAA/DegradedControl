...
ulogOBJ = ulogreader("log_10_2021-6-30-08-03-52.ulg");
...
areamax = 20;
hold on
area([0,18],[areamax,areamax],areamin,'FaceColor','#c0e2c0','EdgeColor','#c0e2c0','FaceAlpha',.3,'EdgeAlpha',.0, ...
    'ShowBaseLine',"off",'LineWidth',5)
hold on
area([18,38],[areamax,areamax],areamin,'FaceColor','#ffd8b7','EdgeColor','#ffd8b7','FaceAlpha',.3,'EdgeAlpha',.0, ...
    'ShowBaseLine',"off",'LineWidth',5)
hold on
area([38,68],[areamax,areamax],areamin,'FaceColor','#A2142F','EdgeColor','#A2142F','FaceAlpha',.15,'EdgeAlpha',.0, ...
    'ShowBaseLine',"off",'LineWidth',5)
hold on
area([68,98],[areamax,areamax],areamin,'FaceColor','#c0e2c0','EdgeColor','#c0e2c0','FaceAlpha',.3,'EdgeAlpha',.0, ...
    'ShowBaseLine',"off",'LineWidth',5)
hold on
area([98,128],[areamax,areamax],areamin,'FaceColor','#ffd8b7','EdgeColor','#ffd8b7','FaceAlpha',.3,'EdgeAlpha',.0, ...
    'ShowBaseLine',"off",'LineWidth',5)
hold on
area([128,160],[areamax,areamax],areamin,'FaceColor','#A2142F','EdgeColor','#A2142F','FaceAlpha',.15,'EdgeAlpha',.0, ...
    'ShowBaseLine',"off",'LineWidth',5)
