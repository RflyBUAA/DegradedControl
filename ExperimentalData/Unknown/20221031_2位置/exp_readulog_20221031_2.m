...
% log_4 似乎是三个旋翼损坏后的位置飞行，具体可以看期望的拉力变化确定是几个旋翼失效
% log_3 似乎上对角旋翼的位置飞行，不过最后有发散的趋势
% log_1 位置跟踪，遥控器拨杆生成期望的位置，飞行器进行跟踪
% log_0 位置控制定点，简短包含了各种故障的的定点飞行
ulogOBJ = ulogreader("log_1_2022-10-31-23-43-56.ulg");
...
ax = gca;
ax.GridLineStyle = '-';
legend("Reference","Measurement",'Interpreter',"latex",'Orientation','vertical')
title("Position X(m)")
